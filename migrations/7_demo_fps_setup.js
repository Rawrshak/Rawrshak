...
module.exports = async function(deployer, networks, accounts) {
    ...
    itemIds = [0,1,2,15,16,17];
    maxAmounts = [0,0,0,0,0,0];
    mintAmounts = [50,50,50,5,5,5];
    ...
    // Player 3 - Gets all the guns
    itemIds = [0, 1, 2];
    await battlefield3Manager.mintBatch(player3Address, itemIds, mintAmounts, {from:electronicArtsAddress, gasPrice: 1});
    
    // Player 4 - Gets Exo character
    itemIds = [15]; 
    mintAmounts = [1];
    await battlefield3Manager.mintBatch(player4Address, itemIds, mintAmounts, {from:electronicArtsAddress, gasPrice: 1});
    
    // Player 5 - Gets all the guns + Swat character
    itemIds = [0, 1, 2, 17]; 
    mintAmounts = [1, 1, 1, 1];
    await battlefield3Manager.mintBatch(player5Address, itemIds, mintAmounts, {from:electronicArtsAddress, gasPrice: 1});


    // Todo: Maybe update this for the UI
