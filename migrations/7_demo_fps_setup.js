...
module.exports = async function(deployer, networks, accounts) {
    ...
    await exchange.placeAsk(electronicArtsAddress, ovcToken.address, itemUUID, 50, web3.utils.toWei('1000', 'gwei'), {from:electronicArtsAddress, gasPrice: 1});
    ...
    await exchange.placeAsk(electronicArtsAddress, ovcToken.address, itemUUID, 5, web3.utils.toWei('1000', 'gwei'), {from:electronicArtsAddress, gasPrice: 1});
    ...
    await exchange.placeBid(player1Address, ovcToken.address, itemUUID, 1, web3.utils.toWei('950', 'gwei'), {from:player1Address, gasPrice: 1});
    
    itemUUID = await registry.getUUID(game.address, 1);
    await exchange.placeAsk(player1Address, ovcToken.address, itemUUID, 1, web3.utils.toWei('1100', 'gwei'), {from:player1Address, gasPrice: 1});
    
    // Player 2 
    itemUUID = await registry.getUUID(game.address, 6);
    await exchange.placeBid(player2Address, ovcToken.address, itemUUID, 1, web3.utils.toWei('975', 'gwei'), {from:player2Address, gasPrice: 1});
    
    itemUUID = await registry.getUUID(game.address, 2);
    await exchange.placeAsk(player2Address, ovcToken.address, itemUUID, 1, web3.utils.toWei('1100', 'gwei'), {from:player2Address, gasPrice: 1});
    
    // Player 3 
    itemUUID = await registry.getUUID(game.address, 7);
    await exchange.placeBid(player3Address, ovcToken.address, itemUUID, 1, web3.utils.toWei('980', 'gwei'), {from:player3Address, gasPrice: 1});
    
    itemUUID = await registry.getUUID(game.address, 3);
    await exchange.placeAsk(player3Address, ovcToken.address, itemUUID, 1, web3.utils.toWei('1100', 'gwei'), {from:player3Address, gasPrice: 1});
