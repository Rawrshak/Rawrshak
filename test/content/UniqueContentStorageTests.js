...
describe('Unique Content Storage Contract Tests', () => {
    ...
    describe("Royalty Tests", () => {
        ...
        it('Update royalty to equal 2e5 and over 2e5', async () => {
            ...
            expect(tokenFees2[0][1]).to.equal(ethers.constants.AddressZero);
            expect(tokenFees2[0][2]).to.equal(ethers.constants.AddressZero);
            expect(tokenFees2[0][3]).to.equal(ethers.constants.AddressZero);
            expect(tokenFees2[1][0]).to.equal(40000);
            expect(tokenFees2[1][1]).to.equal(0);
            expect(tokenFees2[1][2]).to.equal(0);
            expect(tokenFees2[1][3]).to.equal(0);
            ...
            expect(tokenFees3[0][3]).to.equal(ethers.constants.AddressZero);
