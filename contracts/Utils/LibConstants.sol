...
library LibConstants {
    ...
    */
    ...
    // Content Interfaces
    bytes4 constant _INTERFACE_ID_CONTENT = 0xBF2FD945; // 0x94b3e03b;
    bytes4 constant _INTERFACE_ID_CONTENT_STORAGE = 0xA133AF9C; // 0x00000002;
    bytes4 constant _INTERFACE_ID_CONTENT_MANAGER = 0x582136B7; // 0x00000003;
    ...
    bytes4 constant _INTERFACE_ID_CONTRACT_REGISTRY = 0x6C0F49D2; // 0x00000019;
    bytes4 constant _INTERFACE_ID_CONTENT_WITH_HIDDEN_DATA = 0x0000001A;
    bytes4 constant _INTERFACE_ID_TAGS_MANAGER = 0xB06D7CE6; // 0x0000001B;
